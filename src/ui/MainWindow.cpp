...
m_statMenu(new StatMenu(this))
{
    ...
    insertWidget(STAT_MENU, m_statMenu);
    ...
    QObject::connect(m_statMenu, SIGNAL(changeInterface(int)), this, SLOT(setCurrentIndex(int)), Qt::QueuedConnection);
}
